package com.pescod.mobliesecurity.receiver;
...
import com.pescod.mobliesecurity.activity.LostProtectedActivity;

/**
 * Created by pescod on 4/10/2016.
 */
public class OutCallReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.i("------",outnumber);
        //设定拨号进入手机防盗的号码
        String enterPhoneBakNumber = "1006";
        //判断设定的号码是否与广播过来的数据相同
